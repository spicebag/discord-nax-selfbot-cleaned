...
def startprint():
    ...
    print(f'''{Fore.RESET}
                  ...
                  {Fore.RED}╠═╝╠╦╝║ ║ ║║╣ ║   ║   ║║║╠═╣╔╩╦╝
                  {Fore.RED}╩  ╩╚═╚═╝╚╝╚═╝╚═╝ ╩   ╝╚╝╩ ╩╩ ╚═                                                                                                                 
                  {Fore.BLUE} Cleaned by Spicebag
                  {Fore.BLUE} https://github.com/spicebag
                  {Fore.GREEN} Changelog :
			{Fore.GREEN} - Revamped some of the original code.
                  {Fore.GREEN} - Fixed up some of the original sloppy code.
                  {Fore.GREEN} - Removed the token logger from the original.
                  {Fore.YELLOW} Note : This is the original code. Just cleaned, I don't take credit for making the selfbot.
